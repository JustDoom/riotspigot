...
public class NameReferencingFileConverter {
    ...
    public static boolean c(final MinecraftServer minecraftserver) {
        final OpList oplist = new OpList(null);
    ...
    public static boolean d(final MinecraftServer minecraftserver) {
        final WhiteList whitelist = new WhiteList(null);
    ...
    public static String a(String s) {
        if (!UtilColor.b(s) && s.length() <= 16) {
            ...
            if (gameprofile != null && gameprofile.getId() != null) {
                ...
                return arraylist.size() > 0 && ((GameProfile) arraylist.get(0)).getId() != null ? ((GameProfile) arraylist.get(0)).getId().toString() : $.EMPTY_STRING;
            } else {
