...
public class TileEntitySkull extends TileEntity {
    ...
    // Spigot start
    /* Dytanic edit replace with Dytanic Scheduler
        ...
        if (gameprofile != null && !UtilColor.b(gameprofile.getName())) {
            if (gameprofile.isComplete() && gameprofile.getProperties().containsKey("textures")) {
                ...
                if (profile != null && Iterables.getFirst(profile.getProperties().get("textures"), (Object) null) != null) {
                    ...
                    DytanicSpigot.getInstance().getTaskScheduler().schedule(new Runnable() { //Dytanic edit
                        @Override
                        public void run() {
                            final GameProfile profile = skinCache.getUnchecked(gameprofile.getName().toLowerCase());
                            //Dytanic start
                            //MinecraftServer.getServer().processQueue.add(new Runnable() { //Dytanic edit replace with TaskScheduler
