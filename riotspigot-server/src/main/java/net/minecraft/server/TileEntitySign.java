...
public class TileEntitySign extends TileEntity {
    ...
    public final IChatBaseComponent[] lines = new IChatBaseComponent[] { new ChatComponentText($.EMPTY_STRING), new ChatComponentText($.EMPTY_STRING), new ChatComponentText($.EMPTY_STRING), new ChatComponentText($.EMPTY_STRING)};
    public int f = -1;
