...
public class NetworkManager extends SimpleChannelInboundHandler<Packet> {
    ...
    private static final DytanicLogger g = DytanicLogger.getInstance();
    /* Dytanic
    ...
    */
    ...
    private void m() {
        if (this.channel != null && this.channel.isOpen()) {
            //this.j.readLock().lock(); Dytanic edit
            ...
            try {
                ...
                //this.j.readLock().unlock(); Dytanic edit
            }
