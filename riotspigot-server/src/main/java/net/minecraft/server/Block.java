...
import de.dytanic.concurrent.TaskEntryFuture;
...
public class Block {
    ...
    //Dytanic add fast registration with 2 Threads
    public static void S() {

        final Block block = (new Block(Material.STONE)).c(2.0F).b(10.0F).a(Block.i).c("stonebrick").a(CreativeModeTab.b);

        final Block block1 = (new BlockWood()).c(2.0F).b(5.0F).a(Block.f).c("wood");
        final Block block2 = (new BlockSandStone()).a(Block.i).c(0.8F).c("sandStone");

        final Block block3 = (new BlockMushroom()).c(0.0F).a(Block.h).a(0.125F).c("mushroom");

        final Block block4 = (new BlockMushroom()).c(0.0F).a(Block.h).c("mushroom");

        final Block block5 = (new Block(Material.STONE, MaterialMapColor.D)).c(2.0F).b(10.0F).a(Block.i).c("brick").a(CreativeModeTab.b);

        final Block block6 = (new BlockSoil()).c(0.6F).a(Block.g).c("farmland");
        final Block block7 = (new BlockPumpkin()).c(1.0F).a(Block.f).c("pumpkin");

        final Block block8 = (new BlockSmoothBrick()).c(1.5F).b(10.0F).a(Block.i).c("stonebricksmooth");

        TaskEntryFuture<Void> secondRegisterationTask = DytanicSpigot.getInstance().getTaskScheduler().schedule(new Runnable() {
            @Override
            public void run()
            {
