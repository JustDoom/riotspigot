    ...
    */
    ...
    public void a(PacketHandshakingInSetProtocol packethandshakinginsetprotocol) {
        ...
        case 1:
            ...
            /* Dytanic edit remove Connection throttle
            ...
            try {
                ...
                DytanicLogger.getInstance().debug("Failed to check connection throttle", t);
            }
            // CraftBukkit end
            */
            ...
            if (packethandshakinginsetprotocol.b() > 47) {
                ...
                // Spigot Start
                if (org.spigotmc.SpigotConfig.bungee && !MinecraftServer.getServer().server.getOnlineMode()) { //Dytanic edit enable proxy support only if the server is in offline mode
