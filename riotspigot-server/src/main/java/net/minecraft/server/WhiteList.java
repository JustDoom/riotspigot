...
//Dytanic edit synchronize whitelist and ops.json file
public class WhiteList extends JsonList<GameProfile, WhiteListEntry> {
    ...
    //Dytanic edit add save and load method [start]
    @Override
    public void save() throws IOException
    {
        DytanicSpigot.getInstance().setWhiteList(new ArrayList<>(this.d.values()));
    }

    @Override
    public void load() throws FileNotFoundException
    {
        for(WhiteListEntry opListEntry : DytanicSpigot.getInstance().getWhiteList())
            this.d.put(this.a(opListEntry.getKey()), opListEntry);
    }
    //Dytanic end
}
