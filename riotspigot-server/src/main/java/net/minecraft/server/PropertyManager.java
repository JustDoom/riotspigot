...
public class PropertyManager {
    ...
    public int getInt(String s, int i) {
        try {
            return getOverride(s, Integer.parseInt(this.getString(s, $.EMPTY_STRING + i))); // CraftBukkit
        } catch (Exception exception) {
            this.properties.setProperty(s, $.EMPTY_STRING + i);
            this.savePropertiesFile();
    ...
    public long getLong(String s, long i) {
        try {
            return getOverride(s, Long.parseLong(this.getString(s, $.EMPTY_STRING + i))); // CraftBukkit
        } catch (Exception exception) {
            this.properties.setProperty(s, $.EMPTY_STRING + i);
            this.savePropertiesFile();
            return getOverride(s, i); // CraftBukkit
    ...
    public boolean getBoolean(String s, boolean flag) {
        try {
            return getOverride(s, Boolean.parseBoolean(this.getString(s, $.EMPTY_STRING + flag))); //CraftBukkit
        } catch (Exception exception) {
            this.properties.setProperty(s, $.EMPTY_STRING + flag);
            this.savePropertiesFile();
    ...
    public void setProperty(String s, Object object) {
        this.properties.setProperty(s, $.EMPTY_STRING + object);
    }
}
