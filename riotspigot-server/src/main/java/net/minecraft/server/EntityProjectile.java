...
public abstract class EntityProjectile extends Entity implements IProjectile {
    ...
    public void b(NBTTagCompound nbttagcompound) {
        ...
        nbttagcompound.setString("inTile", minecraftkey == null ? $.EMPTY_STRING : minecraftkey.toString());
        ...
        nbttagcompound.setString("ownerName", this.shooterName == null ? $.EMPTY_STRING : this.shooterName);
    }
