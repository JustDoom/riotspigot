...
import de.dytanic.spigot.ChunkCallable;
...
public abstract class MinecraftServer implements Runnable, ICommandListener, IAsyncTaskHandler, IMojangStatistics {
    ...
    public static final DytanicLogger LOGGER = DytanicLogger.getInstance(); //Dytanic edit
    //public static final File a = new File("usercache.json"); Dytanic edit remove caching json file
    private static MinecraftServer l;
    public Convertable convertable;
    //private final MojangStatisticsGenerator n = new MojangStatisticsGenerator("server", this, az()); Dytanic edit remove MojangStatisticGenerator
    public File universe;
    private final List<IUpdatePlayerListBox> p = Lists.newCopyOnWriteArrayList(); //Dytanic edit
    ...
    private String I;
    private String J;
    //private boolean demoMode; Dytanic edit remove demo mode
    private boolean M;
    private boolean N;
    private String O = $.EMPTY_STRING;
    private String P = $.EMPTY_STRING;
    private boolean Q;
    private long R;
    private String S;
    private boolean T;
    ...
    public final Queue<FutureTask<?>> j = new java.util.concurrent.ConcurrentLinkedQueue<>(); // Spigot, PAIL: Rename //Dytanic edit makes public
    private Thread serverThread;
    private long ab = az();

    // CraftBukkit start
    public List<WorldServer> worlds = new ArrayList<>(); //Dytanic edit
    ...
    //public java.util.Queue<Runnable> processQueue = new java.util.concurrent.ConcurrentLinkedQueue<Runnable>(); Dytanic edit remove processQueue
    public int autosavePeriod;
    // CraftBukkit end

    //Dytanic start
    public final Queue<ChunkCallable> chunkQueue = new ConcurrentLinkedQueue<>();
    //Dytanic end

    public MinecraftServer(OptionSet options, Proxy proxy) { //Dytanic edit remove usercache file in constructor
        io.netty.util.ResourceLeakDetector.setEnabled( false ); // Spigot - disable
        this.e = proxy;
        MinecraftServer.l = this;

        reader = DytanicLogger.getInstance().getConsoleReader();

        // this.universe = file; // CraftBukkit
        // this.q = new ServerConnection(this); // Spigot
        this.Z = new UserCache(this);
        this.b = this.h();
    ...
    protected void k() {
        ...
        */
        ...
        for (int m = 0; m < worlds.size(); m++) {
            ...
            /* Dytanic edit remove configuration
            ...
            */
            ...
            server.getPluginManager().callEvent(new org.bukkit.event.world.WorldLoadEvent(worldserver.getWorld())); //Dytanic
        }

        /* Dytanic edit remove iteration
    ...
    protected void a(String s, IDataManager idatamanager) {
        ...
        if (file.isFile()) {
            this.setResourcePack("level://" + s + $.SLASH_STRING + file.getName(), $.EMPTY_STRING);
        }
    ...
    public void stop() throws ExceptionWorldConflict { // CraftBukkit - added throws
        ...
        DytanicSpigot.getInstance().getTaskScheduler().shutdown(); //Dytanic edit
        ...
        if (!this.N) {
            ...
            */
            ...
            //Dytanic start
            DytanicSpigot.getInstance().getTaskScheduler().shutdown();

            try
            {
                DytanicLogger.getInstance().close();
            } catch (Exception e1)
            {
                e1.printStackTrace();
            }
    ...
    //Dytanic start
    private static final int TPS = 40, SAMPLE_INTERVAL = TPS;
    private static final long SEC_IN_NANO = 1000000000, TICK_TIME = SEC_IN_NANO / TPS, MAX_CATCHUP_BUFFER = TICK_TIME * TPS * 60L;
    public final RollingAverage tps1 = new RollingAverage(60), tps5 = new RollingAverage(60 * 5), tps15 = new RollingAverage(60 * 15);
    public double[] recentTps = new double[ 3 ]; // PaperSpigot - Fine have your darn compat with bad plugins

    public volatile boolean defaultTick = false;
    public volatile double currentTps = TPS;
    //Dytanic end
    ...
    public synchronized void run() {
        try {
            if (this.init()) {
                ...
                // Spigot start
                // PaperSpigot start - Further improve tick loop
                Arrays.fill( recentTps, TPS ); //Dytanic edit
                ...
                while (this.isRunning) {
                    ...
                    if ( ++MinecraftServer.currentTick % SAMPLE_INTERVAL == 0 )
                    {
                        ...
                        //Dytanic start
                        if(options.has("showtps")) LOGGER.log(Level.INFO, "Current TPS: " + currentTps);
                    ...
                    defaultTick = !defaultTick; //Dytanic edit
                    this.A();
                    this.Q = true;
                }
                // Spigot end
    ...
    protected synchronized void A() throws ExceptionWorldConflict { // CraftBukkit - added throws
        ...
        if (this.T) {
            this.T = false;
            //this.methodProfiler.a = true; Dytanic edit
            //this.methodProfiler.a(); Dytanic edit
        }

        //this.methodProfiler.a("root"); Dytanic edit
        this.B();
        ...
        */
        ...
        try
        {
            if (autosavePeriod > 0 && (this.ticks / 2) % autosavePeriod == 0)
            { // CraftBukkit
                SpigotTimings.worldSaveTimer.startTiming(); // Spigot
                //this.methodProfiler.a("save"); Dytanic edit
                this.v.savePlayers();
                // Spigot Start
            ...
            */
                ...
                for (World world : worlds) world.getWorld().save(false);
                server.playerCommandState = false;
                // this.saveChunks(true);
                // Spigot End
                //this.methodProfiler.b(); Dytanic edit
        ...
        //this.methodProfiler.a("tallying"); Dytanic edit
    ...
    public synchronized void B() {
        ...
        //this.methodProfiler.a("jobs"); Dytanic edit
        //Queue<FutureTask<?>> queue = this.j; //Dytanic edit add Generic //Dytanic edit use for iteration handling

        // Spigot start
        /* Dytanic edit
        int count = queue.size(); //Dytanic edit use local queue
        while (count-- > 0 && (entry = queue.poll()) != null) { //Dytanic edit use queue
            SystemUtils.a(entry);
         }
         */
        ...
        try
        {
            ...
            //Dytanic start
            for(int i = this.j.size(); i-- > 0; SystemUtils.a(this.j.poll()));
            //Dytanic end
        ...
        //this.methodProfiler.c("levels"); Dytanic edit
        ...
        if(defaultTick)
        {
            ...
            // CraftBukkit start
            this.server.getScheduler().mainThreadHeartbeat(this.ticks / 2);
            SpigotTimings.bukkitSchedulerTimer.stopTiming(); // Spigot
        }
        //Dytanic end

        // Run tasks that are waiting on processing
        /* Dytanic edit remove processQueue
        ...
        */
        ...
        try
        {
            ...
            //Dytanic start
            ChunkCallable chunkCallable;
            if (!this.chunkQueue.isEmpty() && (chunkCallable = this.chunkQueue.poll()) != null)
                try
                {
                    chunkCallable.call();
                } catch (Exception e1)
        ...
        if (this.ticks % 20 == 0) { //Dytanic edit
            DytanicSpigot.getInstance().getTaskScheduler().schedule(new Runnable() {
                @Override
                public void run()
                {
        ...
        for (i = 0; i < this.worlds.size(); ++i) {
            //long j = System.nanoTime(); Dytanic edit

            // if (i == 0 || this.getAllowNether()) {
                WorldServer worldserver = this.worlds.get(i);

                //this.methodProfiler.a(worldserver.getWorldData().getName()); Dytanic edit
                ...
                //this.methodProfiler.a("tick"); Dytanic edit
        ...
        //this.methodProfiler.c("connection"); Dytanic edit
        SpigotTimings.connectionTimer.startTiming(); // Spigot
        this.aq().c();
        SpigotTimings.connectionTimer.stopTiming(); // Spigot
        //this.methodProfiler.c("players"); Dytanic edit
        /* Dytanic edit move to DytanicTaskScheduler
        SpigotTimings.playerListTimer.startTiming(); // Spigot
        this.v.tick();
        SpigotTimings.playerListTimer.stopTiming(); // Spigot
        */
        //this.methodProfiler.c("tickables"); Dytanic edit

        SpigotTimings.tickablesTimer.startTiming(); // Spigot
        for (i = 0; i < p.size(); (p.get(i++)).c()); //Dytanic edit
    ...
    //Dytanic start
    private void initialDytanicSchedulerTask()
    {
        DytanicSpigot.getInstance().getTaskScheduler().schedule(new Runnable() {
            @Override
            public void run()
    ...
    public boolean getAllowNether() {
        return false; //Dytanic edit set default as false
    }
    ...
    public static void main(final OptionSet options) { // CraftBukkit - replaces main(String[] astring)
        ...
        try {
            ...
            dedicatedserver.primaryThread.setPriority(Thread.MIN_PRIORITY);
    ...
    public List<String> tabCompleteCommand(ICommandListener icommandlistener, String s, BlockPosition blockposition) {
        ...
        if (s.startsWith(de.dytanic.$.SLASH_STRING)) {
            s = s.substring(1);
            boolean flag = !s.contains(de.dytanic.$.SPACE_STRING);
            ...
            if (list != null) {
                ...
                while (iterator.hasNext()) {
                    ...
                    if (flag) {
                        arraylist.add(de.dytanic.$.SLASH_STRING + s1);
                    } else {
                        arraylist.add(s1);
                    }
                }
            ...
            String[] astring = s.split(de.dytanic.$.SPACE_STRING, -1);
    ...
    /* Dytanic edit remove Demo service
    public boolean X() {
    ...
    */
    ...
    public <V> ListenableFuture<V> a(Callable<V> callable) {
        ...
        if (!this.isMainThread()) { // CraftBukkit && !this.isStopped()) {
            ...
            //Queue queue = this.j; //Dytanic edit
