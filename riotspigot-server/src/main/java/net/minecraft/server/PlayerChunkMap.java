...
public class PlayerChunkMap {
    ...
    private final ConcurrentHashMap<Long, PlayerChunk> d = new ConcurrentHashMap<>(); //Dytanic edit
    ...
    public void flush() {
        ...
        if (i - this.h > 8000L) {
            ...
            // CraftBukkit start - Use iterator //Dytanic edit optimize with forEach
            for (PlayerChunk aF : this.f)
            {
                playerchunkmap_playerchunk = aF;
    ...
    class PlayerChunk {
        ...
        private volatile boolean loaded = false; //Dytanic edit
        ...
        public PlayerChunk(int i, int j) {
            ...
            MinecraftServer.getServer().chunkQueue.offer(new ChunkCallable(PlayerChunkMap.this.a().chunkProviderServer, i, j, loadedRunnable));
            //Dytanic end
        }
