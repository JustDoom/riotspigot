...
public class PathfinderGoalSelector {
    ...
    private List<PathfinderGoalSelector.PathfinderGoalSelectorItem> b = new UnsafeList<>(); //Dytanic edit
    private List<PathfinderGoalSelector.PathfinderGoalSelectorItem> c = new UnsafeList<>(); //Dytanic edit
