...
public class Chunk {
        ...
        switch (radius) {
            ...
            case 1:
                final int mask =
                        ...
                        (0x1 << (5 +  1 + 12)) | (0x1 << (0 * 5 +  1 + 12)) | (0x1 << (-1 * 5 +  1 + 12)) |
                        (0x1 << (5 +  0 + 12)) | (0x1 << (0 * 5 +  0 + 12)) | (0x1 << (-1 * 5 +  0 + 12)) |
    ...
    public void recheckGaps(final boolean isClientSide) {
        ...
        //world.lightingExecutor.submit(new Runnable() { Dytanic edit replace with taskscheduler
