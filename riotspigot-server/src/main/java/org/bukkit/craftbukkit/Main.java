...
import de.dytanic.util.SystemTimer;
...
public class Main {
    ...
    //Dytanic start
    public static boolean useConsole = true, useJline = true;

    public static final long TIMESTAMP = System.currentTimeMillis();
    //Dytanic end

    public static synchronized void main(String[] args) { //Dytanic edit

        // Todo: Installation script
        OptionParser parser = new OptionParser() {
            {
                accepts("showtps", "Show the tps on the console");
                ...
                */
                ...
                acceptsAll(asList("systemTimer"), "Dytanic CloudNet 2.0-3.0 SystemTimer for Debug CPU and RAM informations");
                // Spigot End

                // PaperSpigot Start
                /* Dytanic edit remove PaperFile support
        ...
        if ((options == null) || (options.has("?"))) {
            ...
            try {
                ...
                useJline = !(jline_UnsupportedTerminal).equals(System.getProperty(jline_terminal)) && !System.getProperty("os.name").toLowerCase().contains("windows");
                ...
                /* Dytanic edit remove no console
                ...
                */
                ...
                for ( String s : java.lang.management.ManagementFactory.getRuntimeMXBean().getInputArguments() )
                {
                    ...
                    {
                        maxPermGen = Integer.parseInt( s.replaceAll( "[^\\d]", de.dytanic.$.EMPTY_STRING ) );
                ...
                */
                ...
                //Dytanic start
                if(options.has("systemTimer"))
                {
                    System.out.println("Enabling SystemTimer:");
                    DytanicSpigot.getInstance().getTaskScheduler().schedule(new SystemTimer(), 1000, -1);
                }

                System.out.println("Loading registry, please wait...");
