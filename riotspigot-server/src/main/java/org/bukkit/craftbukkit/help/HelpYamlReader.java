    ...
    public List<HelpTopic> getGeneralTopics() {
        ...
        if (generalTopics != null) {
            for (String topicName : generalTopics.getKeys(false)) {
                ...
                String shortText = ChatColor.translateAlternateColorCodes(ALT_COLOR_CODE, section.getString("shortText", $.EMPTY_STRING));
                String fullText = ChatColor.translateAlternateColorCodes(ALT_COLOR_CODE, section.getString("fullText", $.EMPTY_STRING));
                String permission = section.getString("permission", $.EMPTY_STRING);
    ...
    public List<HelpTopic> getIndexTopics() {
        ...
        if (indexTopics != null) {
            for (String topicName : indexTopics.getKeys(false)) {
                ...
                String shortText = ChatColor.translateAlternateColorCodes(ALT_COLOR_CODE, section.getString("shortText", $.EMPTY_STRING));
                String preamble = ChatColor.translateAlternateColorCodes(ALT_COLOR_CODE, section.getString("preamble", $.EMPTY_STRING));
                String permission = ChatColor.translateAlternateColorCodes(ALT_COLOR_CODE, section.getString("permission", $.EMPTY_STRING));
    ...
    public List<HelpTopicAmendment> getTopicAmendments() {
        ...
        if (commandTopics != null) {
            for (String topicName : commandTopics.getKeys(false)) {
                ...
                String description = ChatColor.translateAlternateColorCodes(ALT_COLOR_CODE, section.getString("shortText", $.EMPTY_STRING));
                String usage = ChatColor.translateAlternateColorCodes(ALT_COLOR_CODE, section.getString("fullText", $.EMPTY_STRING));
                String permission = section.getString("permission", $.EMPTY_STRING);
