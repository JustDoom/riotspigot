...
public class SpigotConfig
{
    ...
    static int version;
    //static Map<String, Command> commands; Dytanic edit, move command registration to CraftServer
    /*========================================================================*/
    //private static Metrics metrics; Dytanic edit remove Metrics
    ...
    public static void init(File configFile)
    {
        ...
        //commands = new HashMap<String, Command>(); Dytanic edit, move command registration to CraftServer
    ...
    /* Dytanic edit, move command registration to CraftServer
    ...
    public static boolean restartOnCrash = false; //Dytanic edit default disable restart
    ...
    private static void bungee() {
        /* Dytanic edit remove support for lower configurations
        if ( version < 4 )
        {
    ...
    {
        System.setProperty( "io.netty.eventLoopThreads", Integer.toString( 6 ) );
        Bukkit.getLogger().log( Level.INFO, "Using {0} threads for Netty based IO", 6 );
    }
    ...
    //Dytanic start move command registration to CraftServer
    /*
    ...
    */
    ...
    //Dytanic start
    //public static Set<String> replaceCommands = new HashSet<>(); //Dytanic edit remove replacement commands
    /*
    ...
    {
        intCacheLimit = getInt( "settings.int-cache-limit", 512 );
    }
