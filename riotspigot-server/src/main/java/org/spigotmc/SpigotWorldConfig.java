...
public class SpigotWorldConfig
{
    ...
    public void init()
    {
        this.verbose = /*getBoolean( "verbose", false );*/ false; //Dytanic edit remove verbose configuration
    ...
    public final int miscActivationRange = 32; //Dytanic edit
    private void activationRange()
    {
        animalActivationRange = getInt( "entity-activation-range.animals", animalActivationRange );
        monsterActivationRange = getInt( "entity-activation-range.monsters", monsterActivationRange );
        //miscActivationRange = getInt( "entity-activation-range.misc", miscActivationRange ); //Dytanic edit
    ...
    {
        antiXray = getBoolean( "anti-xray.enabled", false ); //Dytanic edit set default false
    ...
    public int maxBulkChunk = 6; //Dytanic edit
    /* Dytanic edit
    private void bulkChunkCount()
    {
        //maxBulkChunk = getInt( "max-bulk-chunks", 5 ); //Dytanic edit set default to 5 from 10
