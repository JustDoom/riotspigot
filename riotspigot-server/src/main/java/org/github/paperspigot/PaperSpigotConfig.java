...
//Dytanic edit remove fragment configuration and set defaults
public class PaperSpigotConfig
{
    ...
    //Dytanic start
    /* Dytanic edit remove command registration
    ...
    */
    ...
    public static Set<Integer> dataValueAllowedItems = Collections.emptySet();
    /*
    ...
    public static boolean stackableLavaBuckets = false;
    public static boolean stackableWaterBuckets = false;
    public static boolean stackableMilkBuckets = false;
    /*
...
*/
    public static boolean warnForExcessiveVelocity = true;
    /*
