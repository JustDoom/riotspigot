...
public final class SimplePluginManager implements PluginManager {
    ...
    public Plugin[] loadPlugins(File directory) {
        ...
        if (!(server.getUpdateFolder().equals($.EMPTY_STRING))) {
    ...
    //Dytanic edit add removePlugin(...) Method
    //Dytanic start
    @Override
    public void removePlugin(Plugin plugin)
    {
        ...
        lookupNames.remove(plugin.getDescription().getName().toLowerCase());
    }
    //Dytanic end
