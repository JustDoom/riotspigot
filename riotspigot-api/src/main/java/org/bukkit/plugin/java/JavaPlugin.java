...
public abstract class JavaPlugin extends PluginBase {
    ...
    public void saveResource(String resourcePath, boolean replace) {
        if (resourcePath == null || resourcePath.equals($.EMPTY_STRING)) {
    ...
    private String replaceDatabaseString(String input) {
        input = input.replaceAll("\\{DIR\\}", dataFolder.getPath().replaceAll("\\\\", $.SLASH_STRING) + $.SLASH_STRING);
        input = input.replaceAll("\\{NAME\\}", description.getName().replaceAll("[^\\w_-]", $.EMPTY_STRING));
        return input;
    }
