...
public final class Bukkit {
    ...
    public static void setServer(Server server) {
        ...
        server.getLogger().info("Running " + getName() + " (Implementing API version " + getBukkitVersion() + ")");
    }
    ...
    //Dytanic start
    public static Server.DytanicServer dytanicServer()
    {
        return server.dytanicServer();
    }
    //Dytanic end
}
